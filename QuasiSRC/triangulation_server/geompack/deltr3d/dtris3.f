...
c        first sorted in lexicographically increasing (x,y,z) order, and
...
c
c     abnormal return:
c        ierr is set to 11, 12, 300, 301, 302, 303, 304, 305,306, or 309
c
c     routines called:
c        dhpsrt,frstet,htins,nwthou,opside,swapes,vbfac
c
...
c
c        find remaining visible boundary faces, add new tetrahedra with
c        vertex i, apply local transf based on empty sphere criterion.
c
