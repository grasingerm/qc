...
//  lattice info
//
std::pair<int,std::vector<std::pair<int,std::pair<int,double>>> > d_latticeInfo;
...
std::pair<int, std::vector<double>>                d_universalConst;
  ...
  private:
     ...
     */
    void
    LoadPotential(const int potentialType);
     ...
     */
    void
    ReadQuasiData(const int                    iQuasi,
                struct lattice_t              *P_lattice,
                struct all_node_list_t      *P_node_list,
                char *                       materialName,
                char                        *input_filename);
    ...
    //  ReadRestartFile()
    //
    void ReadRestartFile(int                    iQuasi,
        const char                              *filename,
    ...
    //  ReadAtomicMass()
    //
    void ReadAtomicMass(int             iQuasi,
        double                     &mass);
     ...
     *
     */    
    void ProcessOptions(char         **init_file,
        char         **data_file,
        int           *number_threads,
     ...
     *
     */    
    int CreateDefaultInitFilename(char        *init_file,
                    size_t              n,
                    char                *name,
                    char const          *ext);
