...
public:
  ...
  void insertEAMPotential(std::pair<int, int> quasicontinuumPair,
                          int potentialType,
                          std::vector<double> potentialParameters,
                          const char *dataFile1, const int NGridPoints,
                          const bool EAMFlag);
  ...
  //  potential
  //
  void getHarmonicApproxData(double &phi, double &dphi, double &d_dphi,
...
private:
   ...
   */
  std::pair<double, double> LJ(int potentialNumber, double r);
  ...
  /**
    ...
    * @return force (first) and energy (second) values.
    */
  std::pair<double, double> EAMJohnson(int potentialNumber, double r);
  ...
  /**
    ...
    * @return force (first) and energy (second) values.
    */
  std::pair<double, double> EAMData(int potentialNumber, double r);
   ...
   * @return force (first) and energy (second) values.
   */
  std::pair<double, double> LJNiMn(int potentialNumber, double r);
   ...
   * @return force (first) and energy (second) values.
   */
  std::pair<double, double> Buckingham(int potentialNumber, double r);
   ...
   * @return force (first) and energy (second) values.
   */
  std::pair<double, double> Harmonic(int potentialNumber, double r);
   ...
   * @return force (first) and energy (second) values.
   */
  std::pair<double, double> Anharmonic(int potentialNumber, double r);
   ...
   * @param r Distance between atoms.
   */
  void LJ_Harmonic(double &phi, double &dphi, double &d_dphi,
                   int potentialNumber, double separation);
   ...
   * @return force (first) and energy (second) values.
   */
  void LJNiMn_Harmonic(double &phi, double &dphi, double &d_dphi,
                       int potentialNumber, double separation);
   ...
   * @return force (first) and energy (second) values.
   */
  void Buckingham_Harmonic(double &phi, double &dphi, double &d_dphi,
                           int potentialNumber, double separation);
   ...
   * @return force (first) and energy (second) values.
   */
  void Harmonic_Harmonic(double &phi, double &dphi, double &d_dphi,
                         int potentialNumber, double separation);
