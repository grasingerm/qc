...
namespace quasicontinuum{
  ...
  public:
    ...
    //
    void createOutputDirectory(int outputFlag,
     ...
     * @brief performOutput()
     */
    void performOutput(const int iQuasi,
        unsigned int              flags,
        std::vector<int> output_flag_vector);
    ...
    int  tecplotOutput(struct all_node_list_t *node_list,
               ...
               const char             *title, 
               const char             *fem_filename,
               const char             *atom_filename,
               const char             *elem_filename,
               const char             *energy_filename,
               const double            time,
               int             i_load);
    ...
    //  testEnergyOutput()
    //
    void testEnergyOutput(std::vector< std::vector< std::vector< std::pair< std::vector< double >, std::vector<double> > > > > *test_cluster_force_energy, 
  ...
  private:
    ...
    void PerformLatticeOutput(const int   iQuasi,
               const char                 *dirname, 
    ...
    void PerformNodeOutput(const int iQuasi,
                const char                  *dirname, 
                const struct node_list_t    *P_node_list,
                const struct element_list_t *P_element_list,
                std::vector<int> output_flag_vector);

    void PerformInputFormat(const int    iQuasi,
                const char               *dirname,
    ...
    void PerformClusterOutput(const int    iQuasi,
                const char         *dirname, 
                struct node_list_t *P_node_list, 
                struct lattice_t   *P_lattice, 
                int                 mark,
    ...
    void PerformIndentOutput(const int    iQuasi,
                const char              *dirname,
    ...
    void PerformClusterForcesOutput(const int    iQuasi,
                const char         *dirname, 
                int                 mark,
                int                 cg_info_flag,
                int                 iteration_number);

    void PerformRestartOutput(const int       iQuasi,
                const char                    *dirname,
    ...
    void OutputDataFilename(char * filename,
        int              iQuasi,
        std::vector<int> output_flag_vector);
