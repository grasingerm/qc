...
public:
  ...
  void insertInputData(const std::vector<double> charges,
                       const double atomisticRadius, const double elementSize,
                       const double electricConstant, const int faceMethod,
  ...
  getElectricField(const int i_quasi) const;
...
private:
   ...
   *
   * @param compute_in_reference Flag to determine whether to compute in
   * reference or not
   */
  ...
  /**
   * @brief Compute contribution to field and potential from fully atomistic
   * atoms.
   *
   * @param compute_in_reference Flag to determine whether to compute in
   * reference or not
  ...
  /**
   * @brief Compute contribution to field and potential from fully external
   * loads.
   *
   * @param compute_in_reference Flag to determine whether to compute in
   * reference or not
