...
namespace quasicontinuum {
  ...
  public:
     ...
     */
    const lattice_t & getLattice() const;
    lattice_t & getLattice();

    const element_list_t & getElementList() const;
    element_list_t & getElementList();

    const all_node_list_t & getNodeList() const;
    all_node_list_t & getNodeList();
  
    const indentor_t & getIndentor() const;
    indentor_t & getIndentor();

    const char * getMaterialName() const;
    char * getMaterialName();  

    const int isRestartOn() const;
    int isRestartOn();  
   ...
   /**
    ...
    getClusterSiteLocationInNodeCluster(int iNode,
								      int iSite);
   ...
   /**
     ...
     */
    std::pair<std::vector<int>, std::vector<double> > 
    getClusterSiteStateInNodeCluster(int iNode,
                                      int iSite);    
   ...
   /**
     ...
     */
    void resetToCurrentPosition(const std::vector<std::vector<double> > currentPositions);
   ...
   /**
    ...
    std::vector<std::pair<std::vector<int>,std::vector<double> > > 
      getNeighborSitesAndStateAroundPoint(const std::pair<std::vector<int>,std::vector<double> > siteState,
   ...
   /**
    ...
    std::vector< std::vector<double> > 
      getNeighborStateAroundPoint(const std::pair<std::vector<int>,std::vector<double> > siteState,
                  const double cutoffRadius);      
     ...
     */
    void getSitesInCluster(const std::vector<int> & site_index_guess,
