...
namespace quasicontinuum{
  ...
  public:
     ...
     */
    void getQuadraturePoints(std::vector<std::vector<std::vector<double> > > & quadVectors,
    ...
    //  
    std::vector< std::pair< std::vector< std::vector<double> > , double > > getQuadratureVectors(int number, int dimension);
