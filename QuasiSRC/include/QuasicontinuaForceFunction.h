...
namespace quasicontinuum {
    ...
    private:
      ...
      //
      QuasicontinuaForceFunction(const QuasicontinuaForceFunction &); // not implemented
      QuasicontinuaForceFunction & operator=(const QuasicontinuaForceFunction &); // not implemented
