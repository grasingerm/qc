...
/* Define to 1 if you have the `pthread_launch_policy_np' function. */
/* #undef HAVE_PTHREAD_LAUNCH_POLICY_NP */
...
/* Define to 1 if you have the `rw_rdlock' function. */
/* #undef HAVE_RW_RDLOCK */

/* Define to 1 if you have the `rw_unlock' function. */
/* #undef HAVE_RW_UNLOCK */

/* Define to 1 if you have the `rw_wrlock' function. */
/* #undef HAVE_RW_WRLOCK */
...
/* Name of package */
#define PACKAGE "libqc3d"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""

/* Define to the full name of this package. */
#define PACKAGE_NAME "LIBQC3D"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LIBQC3D 0.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libqc3d"
