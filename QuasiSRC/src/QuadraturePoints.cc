...
namespace quasicontinuum {
  ...
  void
  QuadraturePoints::destroyInstance()
  {
  ...
  //
  void
  QuadraturePoints::getQuadraturePoints(std::vector<std::vector<std::vector<double> > > & quadVectors,
  ...
  QuadraturePoints::getQuadratureVectors(int number,
    int dimension)
  {
    ...
    switch(quadMethod){
      ...
      case 3:
      {
        ...
        // put vectors and weight into quadVectors and quadWeights
        // 
        //  since we will process two vectors (0,...0,+r,0,..,0) and (0,...0,-r,0,..,0)
      ...
      default:
      {
        d_print("Not valid quad method. Check quasi input and put valid quad method.\n");
        exit(EXIT_FAILURE);
      }
    } // end of switch
