...
namespace quasicontinuum {
  ...
  //
  void RunData::addComputeClusterAndNeighborListTime(int iQuasi,
    double  time)  
  {
  ...
  //
  void RunData::addBuildNeighborListTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addUpdateClusterAndNeighborListTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addComputePairwiseTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //  addComputeEAMTime()
  //
  void RunData::addComputeEAMTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addComputeElectricFieldTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addComputeElectrostaticsTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addComputeEntropyTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addClusterForceToNodeForceTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addInitialToFirstForceCalculationTime(int iQuasi,
    double  time)  
  {
    if(iQuasi >= d_numQuasi)
    {
  ...
  //
  void RunData::addNumberOfClusterSites(int iQuasi,
    int n)  
  {
    if(iQuasi >= d_numQuasi)
    {
