...
namespace quasicontinuum {
	...
	namespace
	{
  		...
  		// 	// std::cout<<"here end of bucket lock"<<std::endl;
			...
			struct AddClusterSiteForcesToNodesData_t{
				...
				std::vector< std::vector< std::pair< std::vector< double >, double > > > * P_clusterForceData;
			};
			...
			void * AddClusterSiteForcesToNodesWorker(void * arg)
			{
					...
					get_share(my_id, number_threads, P_clusterData->size(),
							&number_thread, &bucket_start, &bucket_end);

					struct node_list_t *P_node_list = &(Quasicontinua::getInstance()->getQuasi(iQuasi).getNodeList().node_list);

					struct lattice_t * P_lattice = &(Quasicontinua::getInstance()->getQuasi(iQuasi).getLattice());
					...
					for(int iB= bucket_start; iB <= bucket_end; iB++)
					{
							for(int iC=0; iC < (*P_clusterData)[iB].size(); iC++)
							{
									...
									// process node 0
									double shape  = shapeC->computeSiteShapeFunction(P_node_0,
											P_node_1,
											P_node_2,
											P_node_3,
											l_iC,
									...
									if(node_err == -1)
									{
											...
											P_node_4->energy.potential += nodeWeight * (*P_clusterForceData)[iB][iC].second;

											// P_node_4->energy.kinetic += energy_factor_kinetic * nodeWeight * 3.0 * boltzmanC * temperature/2.0;
											pthread_mutex_unlock(&(P_node_4->lock));
									}

									// add contribution to node_0
									pthread_mutex_lock(&(P_node_0->lock));
									P_node_0->acceleration[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
									P_node_0->acceleration[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
									P_node_0->acceleration[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;

									P_node_0->force_frequency += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

									if(node_err == 0)
									{
											P_node_0->energy.potential += nodeWeight * (*P_clusterForceData)[iB][iC].second;
											// P_node_0->energy.kinetic += nodeWeight * 3.0 * boltzmanC * temperature;
									}
									pthread_mutex_unlock(&(P_node_0->lock));

									// process node 1
									shape  = shapeC->computeSiteShapeFunction(P_node_1,
											P_node_0,
											P_node_2,
											P_node_3,
											l_iC,
									...
									P_node_1->acceleration[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
									P_node_1->acceleration[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
									P_node_1->acceleration[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;

									P_node_1->force_frequency += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
									pthread_mutex_unlock(&(P_node_1->lock));

									// process node 2
									shape  = shapeC->computeSiteShapeFunction(P_node_2,
											P_node_0,
											P_node_1,
											P_node_3,
											l_iC,
									...
									P_node_2->acceleration[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
									P_node_2->acceleration[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
									P_node_2->acceleration[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;

									P_node_2->force_frequency += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
									pthread_mutex_unlock(&(P_node_2->lock));

									// process node 3
									shape  = shapeC->computeSiteShapeFunction(P_node_3,
											P_node_0,
											P_node_1,
											P_node_2,
											l_iC,
									...
									P_node_3->acceleration[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
									P_node_3->acceleration[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
									P_node_3->acceleration[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;

									P_node_3->force_frequency += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
					...
					for(int iB= bucket_start; iB <= bucket_end; iB++)
					{
							for(int iC=0; iC < (*P_clusterData)[iB].size(); iC++)
							{
									...
									double shape  = shapeC->computeSiteShapeFunction(P_node_0,
 									...
 									// add contribution to node_0
									pthread_mutex_lock(&(P_node_0->lock));
									(*P_traceOfKNode)[iC_data.second[0]] += nodeWeight * (*P_traceOfK)[iB][iC] * shape;
									pthread_mutex_unlock(&(P_node_0->lock));
									...
									// add contribution to node_1
									pthread_mutex_lock(&(P_node_1->lock));
									(*P_traceOfKNode)[iC_data.second[1]] += nodeWeight * (*P_traceOfK)[iB][iC] * shape;
									pthread_mutex_unlock(&(P_node_1->lock));
									...
									// add contribution to node_2
									pthread_mutex_lock(&(P_node_2->lock));
									(*P_traceOfKNode)[iC_data.second[2]] += nodeWeight * (*P_traceOfK)[iB][iC] * shape;
									pthread_mutex_unlock(&(P_node_2->lock));
									...
									// add contribution to node_3
									pthread_mutex_lock(&(P_node_3->lock));
									(*P_traceOfKNode)[iC_data.second[3]] += nodeWeight * (*P_traceOfK)[iB][iC] * shape;
									pthread_mutex_unlock(&(P_node_3->lock));
							}
					}
	...
	namespace
	{
		struct iQuasiEAMForceEnergyData_t{
			...
			std::vector< std::vector< std::vector< std::pair< std::vector< double >, double > > > > * P_clusterForceEnergy;
		};

		//
		//  findSiteInVectorLocal()
		//
		void findSiteInVectorLocal(std::vector< std::pair< std::vector<int>, std::vector<double> > > * P_vectors, std::vector<int> site, int & loc)
		{
			//
			//
			//
		...
		//
		void EAMGetNeighborsOfSiteLocal(int iQuasi,
			std::pair<std::vector<int>, std::vector<double> > siteAndState,
			std::vector< std::vector< std::pair< std::vector<int> , std::vector<double> > > > & neighbors,
			int & loc_site_in_quadVector,
			...
			int &     number_neighbors)
		{
			...
			for(int jQuasi = 0; jQuasi < quasiSize; jQuasi++)
			{
				...
				//
				jQuasi_jQuasi_interaction.push_back(pairC->doQuasicontinuumInteract(jQuasi, jQuasi));
				iQuasi_jQuasi_interaction.push_back(pairC->doQuasicontinuumInteract(iQuasi, jQuasi));
				...
				if(iQuasi_jQuasi_interaction[jQuasi] != -1)
				{
					...
					double r_cut = pairC->getCutoffRadiusNeighborList(iQuasi_jQuasi_interaction[jQuasi]);

					neighbors.push_back(quasicontinua->getQuasi(jQuasi).getNeighborSitesAndStateAroundPoint(siteAndState, r_cut));
		...
		//
		void EAMNeighborSiteProcessingLocal(int iQuasi,
			int numQuasi,
			neigh_site_data_t   iNSite_data,
			std::vector< std::vector< std::vector< cluster_site_data_t > > >* P_cluster_data,
				...
				* P_clusterForceEnergy)
		{
			...
			//
			EAMGetNeighborsOfSiteLocal(iQuasi,
					iNSite_data.first,
					neighbors,
					loc_iNSite_in_quadVector,
					iQuasi_quasi_map,
			...
			std::vector< std::pair< std::vector< std::vector<double> > , double > > quadVectors =
				QuadraturePoints::getInstance()->getQuadratureVectors(number_neighbors, 3);
			...
			for(quad =0; quad < quadVectors.size(); quad++)
			{
				...
				for(int it = 0; it < iQuasi_quasi_map.size(); it++)
				{
					...
					for(int jN = 0; jN < neighbors[it].size(); jN++)
					{
						...
						else
						{
							...
							//
							for(int dof =0; dof< 3; dof++)
								r_hat_iN_jN[dof] = iNSite_data.first.second[dof]
									- neighbors[it][jN].second[dof];

							//
							//  get magnitude of r_hat_iN_jN
							//
							double r_hat_mag = sqrt(r_hat_iN_jN[0]*r_hat_iN_jN[0] + r_hat_iN_jN[1]*r_hat_iN_jN[1]
							...
							if( r_hat_mag > meanSeparationTol )
							{
								...
								for(int dof =0; dof< 3; dof++)
									r_hat_iN_jN[dof] =
											factor_iN*quadVectors[quad].first[loc_iNSite_in_quadVector][dof]
								...
								//
								std::pair<double, double> g_dg_jN =
									pairC->getDensityAndDerivative(jQuasi_jQuasi_interaction[jQuasi], r_hat_mag);
				...
				std::pair<double, double> F_dF_iN =
					pairC->getEmbeddingFunctionAndDerivative(jQuasi_jQuasi_interaction[iQuasi], density_iN);
				...
				for(it=0; it < iQuasi_quasi_map.size(); it++)
				{
					...
					struct node_list_t & jQuasi_node_list =
						jQuasi_all_node_list.node_list;
					...
					for(jC=0; jC < iNSite_data.second[jQ].size(); jC++)
					{
							...
							&& jC_data.first.first[2] == iNSite_data.first.first[2])
						{
							...
							//     factor_quad * F_dF_jC.first * P_node_0->weight * quadVectors[quad].second;
							//   pthread_mutex_unlock(&(P_node_0->lock));
							// }
							// else
							// {
							//   struct node_t * P_node_0 = jQuasi_node_list.nodes[jC_data.second[4]];
							...
							(*P_clusterForceEnergy)[jQ][jB][jLoc].second += factor_quad * F_dF_jC.first * quadVectors[quad].second;
							...
							for(kt = 0; kt < iQuasi_quasi_map.size(); kt++)
							{
								...
								for(kN=0; kN < neighbors[kt].size(); kN++)
								{
									...
									else
									{
										...
										// of atom kN and jC
										for(int dof =0; dof < 3; dof++)
											r_hat_jC_kN[dof] = jC_data.first.second[dof]
												- neighbors[kt][kN].second[dof];

										double r_hat_mag = sqrt(r_hat_jC_kN[0]*r_hat_jC_kN[0] + r_hat_jC_kN[1]*r_hat_jC_kN[1]
										...
										{ 
											...
											for(int dof =0; dof < 3; dof++)
												r_hat_jC_kN[dof] =
													...
													- factor_kN * quadVectors[quad].first[vec_counter - 1][dof]
													- neighbors[kt][kN].second[dof];
											...
											//  get g and dg
											//
											//  Note : vector iQuasi_quasi_interaction contains potential number
											//  for (iQuasi, kQuasi), for kQuasi =0 to numQuasi
											//
											//  Note : get function "g" for atom kN, i.e. use kN's potential number
											//  kN belongs to kQ quasi, so use kQ potential number
											//
											std::pair<double,double> g_dg_kN =
												pairC->getDensityAndDerivative(jQuasi_jQuasi_interaction[kQ], r_hat_mag);

											//
											//  add the contribution of kN to f_jC
											//
											//	Note : force due to potential = - derivative of potential
											//
											f_jC[0] +=
												factor_quad * (-g_dg_kN.second) * r_hat_jC_kN[0]
												* F_dF_jC.second * quadVectors[quad].second
												/ r_hat_mag;
											f_jC[1] +=
												factor_quad * (-g_dg_kN.second) * r_hat_jC_kN[1]
												* F_dF_jC.second * quadVectors[quad].second
												/ r_hat_mag;
											f_jC[2] +=
												factor_quad * (-g_dg_kN.second) * r_hat_jC_kN[2]
												* F_dF_jC.second * quadVectors[quad].second
												/ r_hat_mag;
											...
											f_jC[3] +=
												...
												* ( r_hat_jC_kN[0]
														* quadVectors[quad].first[loc_iNSite_in_quadVector][0]
													+ r_hat_jC_kN[1]
														* quadVectors[quad].first[loc_iNSite_in_quadVector][1]
													+ r_hat_jC_kN[2]
														* quadVectors[quad].first[loc_iNSite_in_quadVector][2]
													)
												* F_dF_jC.second * quadVectors[quad].second
												* (- factor_iN/jC_data.first.second[3])
												/ r_hat_mag;
										} // meanSeparationTol test
									} // if site is not iNSite
								} // loop over kN
						...
						else
						{
							...
							if(loc_jC == -1)
							{
								...
								d_print("cluster site = (%d %d, %d) of Quasi %d is not found in neighbors of site = (%i, %i, %i) of Quasi = %i \n",
									jC_data.first.first[0],
									jC_data.first.first[1],
									jC_data.first.first[2],
									jQ,
									iNSite_data.first.first[0],
									iNSite_data.first.first[1],
									iNSite_data.first.first[2],
									iQuasi );
								...
								for(int i=0; i < neighbors.size(); i++)
								{
									...
									for(int j=0; j < neighbors[i].size(); j++)
									{
										d_print("(%d, %d, %d)\n",
											...
											neighbors[i][j].first[1],
											neighbors[i][j].first[2]);
									}
								}

								d_print("**************** dumping associated cluster site of iNSite *************\n");
								for(int i = 0; i < iNSite_data.second.size(); i++)
								{
									...
									{
										d_print("(%d, %d, %d)\n",
											(*P_cluster_data)[i][iNSite_data.second[i][j][0]][iNSite_data.second[i][j][1]].first.first[0],
											(*P_cluster_data)[i][iNSite_data.second[i][j][0]][iNSite_data.second[i][j][1]].first.first[1],
											(*P_cluster_data)[i][iNSite_data.second[i][j][0]][iNSite_data.second[i][j][1]].first.first[2]);
									}
								}

								d_print("*********************** size of data ***********************\n");
								d_print("number of cluster sites associated to iNSite for iQuasi %d is = %d \n", jQ,
									iNSite_data.second[jQ].size() );
							...
							// of atom iN and jC
							for(int dof =0; dof < 3; dof++)
								r_hat_jC_iN[dof] = jC_data.first.second[dof]
									- iNSite_data.first.second[dof];

							//
							//  compute r_hat_mag
							//
							double r_hat_mag = sqrt(r_hat_jC_iN[0]*r_hat_jC_iN[0] + r_hat_jC_iN[1]*r_hat_jC_iN[1]
							...
							{ 
								...
								//
								std::pair<double, double> g_dg_jC =
									pairC->getDensityAndDerivative(jQuasi_jQuasi_interaction[jQ], r_hat_mag);

								//
								//  add the contribution to force
								//
								f_jC[0] +=
									factor_quad * (-g_dg_jC.second) * r_hat_jC_iN[0]
									* F_dF_iN.second * quadVectors[quad].second
									/ r_hat_mag;
								f_jC[1] +=
									factor_quad * (-g_dg_jC.second) * r_hat_jC_iN[1]
									* F_dF_iN.second * quadVectors[quad].second
									/ r_hat_mag;
								f_jC[2] +=
									factor_quad * (-g_dg_jC.second) * r_hat_jC_iN[2]
									* F_dF_iN.second * quadVectors[quad].second
									/ r_hat_mag;

								// frequecny force
								f_jC[3] +=
									factor_quad * (-g_dg_jC.second)
									* ( r_hat_jC_iN[0]
									...
									* F_dF_iN.second * quadVectors[quad].second
									* (- factor_jC/jC_data.first.second[3])
									/ r_hat_mag;
							} // meanSeparationTol test
		...
		//
		void EAMNeighborBucketProcessingLocal(int iQuasi,
			int               numQuasi,
			std::vector< std::vector< neigh_site_data_t > > * P_iQuasi_neighbor_data,
			std::vector< std::vector< std::vector< cluster_site_data_t > > > * P_cluster_data,
			int               bucket_start,
				...
				* P_clusterForceEnergy)
		{
			...
			{
				for(iNSite=0; iNSite < (*P_iQuasi_neighbor_data)[iBucket].size(); iNSite++)
				{
					//
					//  call function to process iNSite
					//
					EAMNeighborSiteProcessingLocal(iQuasi,
						numQuasi,
		...
		{
			int iQuasi =
				((struct iQuasiEAMForceEnergyData_t *)arg)->iQuasi;
			int numQuasi =
				((struct iQuasiEAMForceEnergyData_t *)arg)->numQuasi;
			std::vector< std::vector< neigh_site_data_t > > * P_iQuasi_neighbor_data =
			...
			std::vector< std::vector< std::vector< std::pair< std::vector< double >, double > > > >
				* P_clusterForceEnergy = ((struct iQuasiEAMForceEnergyData_t *)arg)->P_clusterForceEnergy;
			...
			EAMNeighborBucketProcessingLocal(iQuasi,
			 numQuasi,
			 P_iQuasi_neighbor_data,
			 P_cluster_data,
			 bucket_start,
			 bucket_end,
			 P_clusterForceEnergy);
	...
	namespace
	{
		struct iQuasiPairwiseForceEnergyData_t{
			...
			std::vector< std::vector< std::pair< std::vector< double >, double > > > * P_clusterForceEnergy;
		};

		//
		//  PairwiseGetNeighborsOfSiteLocal()
		//
		void PairwiseGetNeighborsOfSiteLocal(int iQuasi,
			std::pair<std::vector<int>, std::vector<double> > siteAndState,
			...
			std::vector<int> & jQuasi_jQuasi_interaction)
		{
			...
			for(int jQuasi = 0; jQuasi < numQuasi; jQuasi++)
			{
				...
				if(iQuasi_jQuasi_interaction[jQuasi] != -1)
				{
					...
					neighbors.push_back(quasicontinua->getQuasi(jQuasi).getNeighborStateAroundPoint(siteAndState, r_cut));
		...
		//
		void PairwiseShellQuasiClusterSiteProcessingLocal(int iQuasi,
					int 								coreQuasi,
				...
				* P_clusterForceEnergy)
		{
			...
			//
			PairwiseGetNeighborsOfSiteLocal(iQuasi,
				iCSite_data.first,
				neighbors,
				iQuasi_quasi_map,
				iQuasi_jQuasi_interaction,
			...
			//				 Phase average is for interaction of shell-shell type
			//
			for(quad = 0; quad < quadVectors.size(); quad++)
			{
				//
				...
				for(it=0; it < iQuasi_quasi_map.size(); it++)
				{
					...
					if(jQ != coreQuasi)
					{
						...
						for(jN =0; jN < neighbors[it].size(); jN++)
						{
							...
							{
								for(int dof=0; dof<3; dof++)
									r_hat_iC_jN[dof] = r_hat_iC_jN[dof]
										+ factor_iC * quadV_1[dof] - factor_jN * quadV_2[dof];
								...
								std::pair<double,double> dphi_phi =
									pairC->getPairForceAndEnergy(iQuasi_jQuasi_interaction[jQ],
										r_hat_mag);
								...
								//
								f_iC[0] +=  factor_quad * (dphi_phi.first)
													* r_hat_iC_jN[0]
													* quadWeight
													/ r_hat_mag;

								f_iC[1] +=  factor_quad * (dphi_phi.first)
													* r_hat_iC_jN[1]
													* quadWeight
													/ r_hat_mag;

								f_iC[2] +=  factor_quad * (dphi_phi.first)
													* r_hat_iC_jN[2]
													* quadWeight
													/ r_hat_mag;

								f_iC[3] +=  factor_quad * (dphi_phi.first)
													* ( r_hat_iC_jN[0] * quadV_1[0]
														 +r_hat_iC_jN[1] * quadV_1[1]
														 +r_hat_iC_jN[2] * quadV_1[2]
														)
													* (-factor_iC/iCSite_data.first.second[3])
													* quadWeight
													/ r_hat_mag;
							} // meanSeparationTol test
			...
			if(coreQuasi != -1)
			{
				...
				else
				{
				  ...
				  for(int jN=0; jN < neighbors[it_coreQuasi].size(); jN++)
				  {
				  	...
				  	//
						std::pair<double,double> dphi_phi =
							pairC->getPairForceAndEnergy(iQuasi_jQuasi_interaction[coreQuasi],
								r_hat_mag);
		...
		//  PairwiseClusterSiteProcessingLocal()
		//
		void PairwiseCoreQuasiClusterSiteProcessingLocal(int iQuasi,
					int 								coreQuasi,
					cluster_site_data_t iCSite_data,
					int 	iC_bucket,
					int 	iC_location,
				...
				* P_clusterForceEnergy)
		{
			...
			if(potentialNumber != -1)
			{
				...
				neighbors = Quasicontinua::getInstance()->getQuasi(coreQuasi).getNeighborStateAroundPoint(iCSite_data.first, r_cut);
		...
		//
		void PairwiseClusterBucketProcessingLocal(int iQuasi,
			int   numQuasi,
			std::pair<int,int> 	coreFlag,
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data,
			int bucket_start,
				...
				* P_clusterForceEnergy)
		{
			...
			for(iBucket = bucket_start; iBucket <= bucket_end; iBucket++)
			{
				for(iCSite = 0; iCSite < (*P_iQuasi_cluster_data)[iBucket].size(); iCSite++)
				{
					//
					//  process cluster site
					//
					cluster_site_data_t iCSite_data = (*P_iQuasi_cluster_data)[iBucket][iCSite];

					//
					//  call function to process current cluster site of iQuasi
					//
					if(coreFlag.first == -1)
						PairwiseShellQuasiClusterSiteProcessingLocal(iQuasi,
							coreFlag.second,
							iCSite_data,
							iBucket,
							iCSite,
						...
						PairwiseCoreQuasiClusterSiteProcessingLocal(iQuasi,
							coreFlag.second,
							iCSite_data,
							iBucket,
							iCSite,
		...
		{
			int iQuasi =
				((struct iQuasiPairwiseForceEnergyData_t *)arg)->iQuasi;
			int numQuasi =
				((struct iQuasiPairwiseForceEnergyData_t *)arg)->numQuasi;
			std::pair<int, int> coreFlag =
				((struct iQuasiPairwiseForceEnergyData_t *)arg)->coreFlag;
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data
			= ((struct iQuasiPairwiseForceEnergyData_t *)arg)->P_iQuasi_cluster_data;
			std::vector< std::vector< std::pair< std::vector< double >, double > > >
				* P_clusterForceEnergy = ((struct iQuasiPairwiseForceEnergyData_t *)arg)->P_clusterForceEnergy;
			...
			PairwiseClusterBucketProcessingLocal(iQuasi,
				numQuasi,
				coreFlag,
	...
	namespace
	{
		...
		//  PairwiseClusterSiteProcessingLocal()
		//
		void PairwiseHarmonicShellQuasiClusterSiteProcessingLocal(int iQuasi,
					int 								coreQuasi,
					cluster_site_data_t iCSite_data,
					int 	iC_bucket,
					int 	iC_location,
				...
				for(jN =0; jN < neighbors[it].size(); jN++)
				{
  				...
  				r_hat_mag = sqrt(r_hat_iC_jN[0]*r_hat_iC_jN[0]
					...
					if(r_hat_mag > meanSeparationTol)
					{
						...
						pairC->getHarmonicApproxData(phi,
							dphi,
							d_dphi,
							iQuasi_jQuasi_interaction[jQ],
							r_hat_mag);
		...
		//  PairwiseClusterSiteProcessingLocal()
		//
		void PairwiseHarmonicCoreQuasiClusterSiteProcessingLocal(int iQuasi,
					int 								coreQuasi,
					cluster_site_data_t iCSite_data,
					int 	iC_bucket,
					int 	iC_location,
		...
		//  PairwiseShellQuasiClusterBucketProcessingLocal()
		//
		void PairwiseHarmonicClusterBucketProcessingLocal(int iQuasi,
			int   numQuasi,
			std::pair<int,int> 	coreFlag,
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data,
			int bucket_start,
			...
			std::vector< std::vector< double > >  * P_traceOfK)
		{
			...
			for(iBucket = bucket_start; iBucket <= bucket_end; iBucket++)
			{
				for(iCSite = 0; iCSite < (*P_iQuasi_cluster_data)[iBucket].size(); iCSite++)
				{
					...
					//
					if(coreFlag.first == -1)
						PairwiseHarmonicShellQuasiClusterSiteProcessingLocal(iQuasi,
							coreFlag.second,
							iCSite_data,
							iBucket,
							iCSite,
						...
						PairwiseHarmonicCoreQuasiClusterSiteProcessingLocal(iQuasi,
							coreFlag.second,
							iCSite_data,
							iBucket,
							iCSite,
		...
		{
			int iQuasi =
				((struct iQuasiPairwiseForceEnergyHarmonicData_t *)arg)->iQuasi;
			int numQuasi =
				((struct iQuasiPairwiseForceEnergyHarmonicData_t *)arg)->numQuasi;
			std::pair<int, int> coreFlag =
				((struct iQuasiPairwiseForceEnergyHarmonicData_t *)arg)->coreFlag;
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data
			= ((struct iQuasiPairwiseForceEnergyHarmonicData_t *)arg)->P_iQuasi_cluster_data;
			std::vector< std::vector< std::pair< std::vector< double >, double > > >
				* P_clusterForceEnergy = ((struct iQuasiPairwiseForceEnergyHarmonicData_t *)arg)->P_clusterForceEnergy;
			std::vector< std::vector< double > > * P_traceOfK =
			...
			PairwiseHarmonicClusterBucketProcessingLocal(iQuasi,
				numQuasi,
				coreFlag,
				P_iQuasi_cluster_data,
				bucket_start,
	...
	namespace
	{
		...
		{
			int iQuasi =
				((struct iQuasiEntropyForceEnergyData_t *)arg)->iQuasi;
			int numQuasi =
				((struct iQuasiEntropyForceEnergyData_t *)arg)->numQuasi;
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data
			= ((struct iQuasiEntropyForceEnergyData_t *)arg)->P_iQuasi_cluster_data;
			std::vector< std::vector< std::pair< std::vector< double >, double > > >
				* P_clusterForceEnergy = ((struct iQuasiEntropyForceEnergyData_t *)arg)->P_clusterForceEnergy;
			...
			std::vector<double> universalConstants = PairPotentials::getInstance()->getUniversalConstants();
			...
			std::vector<double> sigmaVector = Quasicontinua::getInstance()->getSigmaVector();

			int iBucket;
			int iCluster;
			for(iBucket = bucket_start; iBucket <= bucket_end; iBucket++)
			{
				for(iCluster =0; iCluster < (*P_iQuasi_cluster_data)[iBucket].size(); iCluster++)
				{
					...
					double entropy = 3.0 * boltzmanC * log(sigmaVector[iQuasi] * sigmaVector[iQuasi]/(maxPlanck_pi * freq)) + 4 * boltzmanC;
					entropy = entropy * energy_factor_entropy;

					double d_entropy = -3.0 * boltzmanC / freq;
					d_entropy = d_entropy * energy_factor_entropy;

					double kinetic_energy = 3.0 * boltzmanC * temperature * energy_factor_entropy/2.0;
					...
					(*P_clusterForceEnergy)[iBucket][iCluster].first[3] += temperature * d_entropy;

					(*P_clusterForceEnergy)[iBucket][iCluster].second += -entropy * temperature;
		...
		{
			int iQuasi =
				((struct iQuasiEntropyForceEnergyHarmonicData_t *)arg)->iQuasi;
			int numQuasi =
				((struct iQuasiEntropyForceEnergyHarmonicData_t *)arg)->numQuasi;
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data
			= ((struct iQuasiEntropyForceEnergyHarmonicData_t *)arg)->P_iQuasi_cluster_data;
			std::vector< std::vector< std::pair< std::vector< double >, double > > >
				* P_clusterForceEnergy = ((struct iQuasiEntropyForceEnergyHarmonicData_t *)arg)->P_clusterForceEnergy;
			std::vector< std::vector< double > > * P_traceOfK =
			...
			for(iBucket = bucket_start; iBucket <= bucket_end; iBucket++)
			{
				for(iCluster =0; iCluster < (*P_iQuasi_cluster_data)[iBucket].size(); iCluster++)
				{
					...
					double a = 6.0 * boltzmanC * temperature * energy_factor_entropy / maxPlanck_pi;
					...
					double d_entropy = -3.0 * boltzmanC * (-traceK/(freq*freq) + 3.0*energy_factor_kinetic/mass)/(b);
				  ...
				  d_entropy = d_entropy * energy_factor_entropy;
					...
					(*P_clusterForceEnergy)[iBucket][iCluster].second += -entropy * temperature + add_energy;
					pthread_mutex_unlock(&bucketLock[iQuasi][iBucket]);
				}
			}
	...
	namespace
	{
		...
		//
		void ElectrostaticsClusterBucketProcessingLocal(int iQuasi,
			int   													numQuasi,
			bool 														compute_in_reference,
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data,
			int 														bucket_start,
				...
				* P_clusterForceEnergy)
		{
			...
			for(iBucket = bucket_start; iBucket <= bucket_end; iBucket++)
			{
				...
				//
				if((*P_clusterForceEnergy)[iBucket].size() < (*P_iQuasi_cluster_data)[iBucket].size())
				{
					pthread_mutex_lock(&(bucketLock[iQuasi][iBucket]));
					d_print("Check InitializeClusterForceEnergyData(), size of cluster force and clustyer site data must match\n");
					pthread_mutex_unlock(&(bucketLock[iQuasi][iBucket]));
				}
				...
				for(iCSite = 0; iCSite < (*P_iQuasi_cluster_data)[iBucket].size(); iCSite++)
				{
					...
					Electrostatics::getInstance()->computeForceOnSite(iQuasi,
						iCSite_data,
						force,
						energy,
		...
		{
			int iQuasi =
				((struct iQuasiElectrostaticsForceEnergyData_t *)arg)->iQuasi;
			int numQuasi =
				((struct iQuasiElectrostaticsForceEnergyData_t *)arg)->numQuasi;
			bool compute_in_reference =
				((struct iQuasiElectrostaticsForceEnergyData_t *)arg)->compute_in_reference;
			std::vector< std::vector< cluster_site_data_t > > * P_iQuasi_cluster_data
			= ((struct iQuasiElectrostaticsForceEnergyData_t *)arg)->P_iQuasi_cluster_data;
			std::vector< std::vector< std::pair< std::vector< double >, double > > >
				* P_clusterForceEnergy = ((struct iQuasiElectrostaticsForceEnergyData_t *)arg)->P_clusterForceEnergy;
			...
			ElectrostaticsClusterBucketProcessingLocal(iQuasi,
				numQuasi,
				compute_in_reference,
				P_iQuasi_cluster_data,
				bucket_start,
	...
	namespace
	{
		...
		struct testAddForceEnergyData_t{
			...
			std::vector< std::vector< std::pair< std::vector< double >, std::vector<double> > > >   *P_testClusterForceData;
			std::vector< std::pair< std::vector<double>, std::vector<double> > > *P_testNodeForceData;
    	std::vector< std::vector< std::pair< std::vector< double >, double > > >  *P_testTotalClusterForceData;
		...
		void * testAddForceEnergyWorker(void * arg)
		{
			...
			get_share(my_id, number_threads, P_clusterSiteData->size(),
					&number_thread, &bucket_start, &bucket_end);
			...
			for(int iB= bucket_start; iB <= bucket_end; iB++)
			{
					for(int iC=0; iC < (*P_clusterSiteData)[iB].size(); iC++)
					{
							...
							if(flag == 2)
							{
								(*P_testClusterForceData)[iB][iC].first[freqIndex] = (*P_clusterForceData)[iB][iC].first[3];

								(*P_testClusterForceData)[iB][iC].second[energyIndex] = (*P_clusterForceData)[iB][iC].second;

								(*P_testTotalClusterForceData)[iB][iC].first[3] += (*P_clusterForceData)[iB][iC].first[3];

								(*P_testTotalClusterForceData)[iB][iC].second += (*P_clusterForceData)[iB][iC].second;
							}
							else
							{
								(*P_testClusterForceData)[iB][iC].first[forceIndex[0]] = (*P_clusterForceData)[iB][iC].first[0];
								(*P_testClusterForceData)[iB][iC].first[forceIndex[1]] = (*P_clusterForceData)[iB][iC].first[1];
								(*P_testClusterForceData)[iB][iC].first[forceIndex[2]] = (*P_clusterForceData)[iB][iC].first[2];
								(*P_testClusterForceData)[iB][iC].first[forceIndex[3]] = (*P_clusterForceData)[iB][iC].first[3];

								(*P_testClusterForceData)[iB][iC].second[energyIndex] = (*P_clusterForceData)[iB][iC].second;

								// total cluster data
								(*P_testTotalClusterForceData)[iB][iC].first[0] += (*P_clusterForceData)[iB][iC].first[0];
								(*P_testTotalClusterForceData)[iB][iC].first[1] += (*P_clusterForceData)[iB][iC].first[1];
								(*P_testTotalClusterForceData)[iB][iC].first[2] += (*P_clusterForceData)[iB][iC].first[2];
								(*P_testTotalClusterForceData)[iB][iC].first[3] += (*P_clusterForceData)[iB][iC].first[3];
		  				...
		  				int node_err = 0;
							...
							if(flag == 2)
							{
								(*P_testNodeForceData)[node_0].first[freqIndex] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_0].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}
							else
							{
								(*P_testNodeForceData)[node_0].first[forceIndex[0]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testNodeForceData)[node_0].first[forceIndex[1]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testNodeForceData)[node_0].first[forceIndex[2]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testNodeForceData)[node_0].first[forceIndex[3]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_0].first[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testTotalNodeForceData)[node_0].first[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testTotalNodeForceData)[node_0].first[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testTotalNodeForceData)[node_0].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}

							if(node_err == 0)
							{
								(*P_testNodeForceData)[node_0].second[energyIndex] += nodeWeight * (*P_clusterForceData)[iB][iC].second;

								(*P_testTotalNodeForceData)[node_0].second += nodeWeight * (*P_clusterForceData)[iB][iC].second;
							}
							pthread_mutex_unlock(&lock_print);
							...
							if(flag == 2)
							{
								(*P_testNodeForceData)[node_1].first[freqIndex] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_1].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}
							else
							{
								(*P_testNodeForceData)[node_1].first[forceIndex[0]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testNodeForceData)[node_1].first[forceIndex[1]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testNodeForceData)[node_1].first[forceIndex[2]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testNodeForceData)[node_1].first[forceIndex[3]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_1].first[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testTotalNodeForceData)[node_1].first[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testTotalNodeForceData)[node_1].first[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testTotalNodeForceData)[node_1].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}
							pthread_mutex_unlock(&lock_print);
							...
							if(flag == 2)
							{
								(*P_testNodeForceData)[node_2].first[freqIndex] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_2].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}
							else
							{
								(*P_testNodeForceData)[node_2].first[forceIndex[0]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testNodeForceData)[node_2].first[forceIndex[1]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testNodeForceData)[node_2].first[forceIndex[2]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testNodeForceData)[node_2].first[forceIndex[3]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_2].first[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testTotalNodeForceData)[node_2].first[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testTotalNodeForceData)[node_2].first[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testTotalNodeForceData)[node_2].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}
							pthread_mutex_unlock(&lock_print);
							...
							if(flag == 2)
							{
								(*P_testNodeForceData)[node_3].first[freqIndex] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_3].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}
							else
							{
								(*P_testNodeForceData)[node_3].first[forceIndex[0]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testNodeForceData)[node_3].first[forceIndex[1]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testNodeForceData)[node_3].first[forceIndex[2]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testNodeForceData)[node_3].first[forceIndex[3]] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;

								(*P_testTotalNodeForceData)[node_3].first[0] += nodeWeight * (*P_clusterForceData)[iB][iC].first[0] * shape;
								(*P_testTotalNodeForceData)[node_3].first[1] += nodeWeight * (*P_clusterForceData)[iB][iC].first[1] * shape;
								(*P_testTotalNodeForceData)[node_3].first[2] += nodeWeight * (*P_clusterForceData)[iB][iC].first[2] * shape;
								(*P_testTotalNodeForceData)[node_3].first[3] += nodeWeight * (*P_clusterForceData)[iB][iC].first[3] * shape;
							}
							pthread_mutex_unlock(&lock_print);
					}
	...
	ForceEnergyCalculation::getInstance()
	{
	...
	void
	ForceEnergyCalculation::destroyInstance()
	{
	...
	//
	void ForceEnergyCalculation::setRemoveResidualFlags(const std::vector<int> flags)
	{
			//
		...
		void ForceEnergyCalculation::removeResidualForces(void)
		{
			...
			{
				std::vector<std::vector<double> > iQuasiStates = quasicontinua->getQuasi(iQuasi).resetToInitialState();
			...
			for(int iQuasi =0; iQuasi < numQuasi; iQuasi++)
			{
					...
					for(int iNode = 0; iNode < P_all_node_list->node_list.number_nodes; iNode++)
					{
		  ...
		  if(RunData::getInstance()->d_timeOut == true)
		    RunData::getInstance()->addComputeResidualForceTime(0,
		     	elapsedTime);
			return;
	...
	//
	void ForceEnergyCalculation::SetResidualFlagsForAdjacentNodes(const struct node_t *P_node,
		...
		bool compute_in_reference)
	{
		...
		neighborC->computeCrossNeighborList(rebuild_neighbor_flag, rebuild_cluster_flag);
		...
		if(Electrostatics::getInstance()->isElectrostaticEnable() == 1)
		{
			if(flag_elctric != -1)
			{
		  	...
		  	elapsedTime += (t2.tv_usec - t1.tv_usec) / 1000000.0;
		  	if(RunData::getInstance()->d_timeOut == true)
		      RunData::getInstance()->addComputeElectricFieldTime(0,
		      	elapsedTime);
			}
		}
  	...
  	// initialize the force data
		...
		//
		//  loop over each quasi and compute force at cluster sites and nodes(electrostatics
		...
		bool compute_in_reference)
	{
    	...
    	elapsedTime += (t2.tv_usec - t1.tv_usec) / 1000000.0;
    	if(RunData::getInstance()->d_timeOut == true)
	      RunData::getInstance()->addComputeEAMTime(iQuasi,
        	elapsedTime);
		}
  	...
  	elapsedTime += (t2.tv_usec - t1.tv_usec) / 1000000.0;
  	if(RunData::getInstance()->d_timeOut == true)
      RunData::getInstance()->addComputePairwiseTime(iQuasi,
      	elapsedTime);
		...
		if(coreFlag == -1)
		{
	  	...
	  	elapsedTime += (t2.tv_usec - t1.tv_usec) / 1000000.0;
	  	if(RunData::getInstance()->d_timeOut == true)
	      RunData::getInstance()->addComputeEntropyTime(iQuasi,
	      	elapsedTime);
		}
		...
		if(Electrostatics::getInstance()->isElectrostaticEnable() == 1)
		{
	  	...
	  	elapsedTime += (t2.tv_usec - t1.tv_usec) / 1000000.0;
	  	if(RunData::getInstance()->d_timeOut == true)
	      RunData::getInstance()->addComputeElectrostaticsTime(iQuasi,
	      	elapsedTime);
		}
	...
	//  iQuasiForceEnergy()
	//
	void ForceEnergyCalculation::iQuasiForceEnergyHarmonic(int iQuasi,
		bool compute_in_reference)
	{
		//
		//  get Quasicontinua handle
	...
	void ForceEnergyCalculation::iQuasiAddForceAndEnergyToNodes(int iQuasi)
	{
  	...
  	elapsedTime += (t2.tv_usec - t1.tv_usec) / 1000000.0;
  	if(RunData::getInstance()->d_timeOut == true)
      RunData::getInstance()->addClusterForceToNodeForceTime(iQuasi,
      	elapsedTime);
	...
	{
		// std::cout<<"ForceEnergyCalculation : Computing EAM force and Energy for Quasi = "<<iQuasi<<std::endl;
	...
	void ForceEnergyCalculation::iQuasiPairwiseForceEnergy(int iQuasi)
	{
		...
		// 	// cluster force data
		// 	fprintf(file, "*** testing d_clusterForceEnergy[iQausi] iQuasi = %d***\n", iQuasi);
		...
		// 			// if(d_clusterForceEnergy[iQuasi][i][j].second.size() > 2)
		// 			// 	fprintf(file, "error in site number %d of bucket %d\n", j, i);						
		// 		}
		// 	}
		// 	fprintf(file, "total number of data in all buckets = %d\n", n);
	...
	//
	void ForceEnergyCalculation::iQuasiElectrostaticsForceEnergy(int iQuasi,
			bool        compute_in_reference)
	{
		// std::cout<<"ForceEnergyCalculation : Computing Electrostatics force and Energy for Quasi = "<<iQuasi<<std::endl;
	...
	void ForceEnergyCalculation::AddClusterSiteForcesToNodes(int iQuasi)
	{
		...
		data.iQuasi = iQuasi;
		data.P_clusterData = &(CrossNeighborList::getInstance()->getQuasiClusterData(iQuasi));
	...
	void ForceEnergyCalculation::ComputeTraceOfKAtNodes(int 	iQuasi)
	{
		...
		// 	d_print("number of buckets in d_traceOfK (%u) and clusterData (%u) don't match\n", d_traceOfK[iQuasi].size(), clusterData.size());

		// for(int i=0; i < clusterData.size(); i++)
		// 	if(clusterData[i].size() != d_traceOfK[iQuasi][i].size())
		// 		d_print("in bucket = %d number of cluster data in clusterData (%u) and d_traceOfK (%u) don't match\n", i, clusterData[i].size(), d_traceOfK[iQuasi][i].size());
		// d_print("test done\n");
	...
	{
		// std::cout<<"ForceEnergyCalculation : Adding External Forces for Quasi = "<<iQuasi<<std::endl;
	...
	{
		// std::cout<<"ForceEnergyCalculation : Compute External Energy for Quasi = "<<iQuasi<<std::endl;
	...
	{
		// std::cout<<"ForceEnergyCalculation : Compute Total Energy for Quasi = "<<iQuasi<<std::endl;
	...
	{
		// std::cout<<"ForceEnergyCalculation : Adding all Energy to all_node_list of Quasi = "<<iQuasi<<std::endl;
		...
		// update total energy
		all_node_list.energy.total = all_node_list.energy.kinetic + all_node_list.energy.potential;
	...
	void ForceEnergyCalculation::copyEnergyToInitialEnergy(void)
	{
		...
		{
			// get all node list
			struct all_node_list_t & all_node_list = quasicontinua->getQuasi(iQuasi).getNodeList();
	...
	void ForceEnergyCalculation::InitializeClusterForceEnergyData()
	{
		...
		const std::vector< std::vector< std::vector< cluster_site_data_t > > > & clusterData =
			crossC->getClusterData();
		...
		// initialize the data
		if(d_clusterForceEnergy.size() == 0 || d_clusterForceEnergy.size() > numQuasi)
		...
		for(int iQuasi=0; iQuasi< numQuasi; iQuasi++)
		{
			...
			for(int bucket=0; bucket < clusterData[iQuasi].size(); bucket++)
			{
				...
				|| d_clusterForceEnergy[iQuasi][bucket].size() 
					...
					d_clusterForceEnergy[iQuasi][bucket].resize(clusterData[iQuasi][bucket].size());

				for(int i_cluster = 0; i_cluster < clusterData[iQuasi][bucket].size(); i_cluster++)
				{
	...
	//
	std::vector< std::vector< std::pair< std::vector< double >, double > > > & ForceEnergyCalculation::getQuasiClusterSiteForceData(int iQuasi)
	{
	...
	//
	void ForceEnergyCalculation::testForceEnergyCalculation(int rebuild_neighbor_flag,
		int rebuild_cluster_flag,
    ...
    std::vector< std::vector< std::pair< std::vector<double>, double > > > &test_total_node_force_energy)
	{
		...
		//	Initialize the data
		//
		InitializeTestForceEnergyData(test_cluster_force_energy,
		...
		if(PairPotentials::getInstance()->d_EAMFlag == true)
		{
			...
			//
			flag = 0;  // 0 for EAM
			testAddForceEnergy(test_cluster_force_energy,
				test_node_force_energy,
				test_total_cluster_force_energy,
				test_total_node_force_energy,
				flag);
	...
	//
	void ForceEnergyCalculation::InitializeTestForceEnergyData(std::vector< std::vector< std::vector< std::pair< std::vector< double >, std::vector<double> > > > >  &test_cluster_force_energy,
    std::vector< std::vector< std::pair< std::vector<double>, std::vector<double> > > > &test_node_force_energy,
    std::vector< std::vector< std::vector< std::pair< std::vector< double >, double > > > > &test_total_cluster_force_energy,
    std::vector< std::vector< std::pair< std::vector<double>, double > > > &test_total_node_force_energy)
	{
		...
		d_print("quasi size = %d, numbuckets = %d\n", clusterData.size(), clusterData[0].size());
		for(int k = 0; k < 10; k++)
		{
		...
		for(int iQuasi=0; iQuasi< numQuasi; iQuasi++)
		{
			...
			struct node_list_t node_list = Quasicontinua::getInstance()->getQuasi(iQuasi).getNodeList().node_list;
  ...
  //         3 - electrostatics
  //
  void ForceEnergyCalculation::testAddForceEnergy(std::vector< std::vector< std::vector< std::pair< std::vector< double >, std::vector<double> > > > >  &test_cluster_force_energy,
    std::vector< std::vector< std::pair< std::vector<double>, std::vector<double> > > > &test_node_force_energy,
    std::vector< std::vector< std::vector< std::pair< std::vector< double >, double > > > > &test_total_cluster_force_energy,
    std::vector< std::vector< std::pair< std::vector<double>, double > > > &test_total_node_force_energy,
      int                flag)
  {
  	for(int iQuasi = 0; iQuasi < d_clusterForceEnergy.size(); iQuasi++)
  	{
  		...
  		data.flag = flag;
  		data.P_clusterForceData = &(d_clusterForceEnergy[iQuasi]);
  		data.P_clusterSiteData = &(CrossNeighborList::getInstance()->getQuasiClusterData(iQuasi));
  		data.P_testClusterForceData = &(test_cluster_force_energy[iQuasi]);
  		data.P_testNodeForceData = &(test_node_force_energy[iQuasi]);
  		data.P_testTotalClusterForceData = &(test_total_cluster_force_energy[iQuasi]);
  ...
  void ForceEnergyCalculation::InitializeTraceOfKData()
  {
		...
		for(int iQuasi=0; iQuasi< numQuasi; iQuasi++)
		{
			if(d_traceOfK[iQuasi].size() == 0 || d_traceOfK[iQuasi].size() > numBuckets)
				d_traceOfK[iQuasi].resize(numBuckets);

			for(int bucket=0; bucket < clusterData[iQuasi].size(); bucket++)
			{
				if(d_traceOfK[iQuasi][bucket].size() == 0 || d_traceOfK[iQuasi][bucket].size() > clusterData[iQuasi][bucket].size())
  ...
  //
  std::vector<std::vector<double>> & ForceEnergyCalculation::getQuasiClusterTraceOfK(int iQuasi)
  {
  ...
  void ForceEnergyCalculation::InitializeNewBucketLock()
  {
 	// 	newBucketLock.clear();
		...
		// 	for(int bucket=0; bucket < d_clusterForceEnergy[iQuasi].size(); bucket++)
		// 	{
		// 		for(int i_cluster = 0; i_cluster < d_clusterForceEnergy[iQuasi][bucket].size(); i_cluster++)
		// 		{
		...
		// 	d_print("Check initialization of newBucketLock. Quasi size don't match\n");
